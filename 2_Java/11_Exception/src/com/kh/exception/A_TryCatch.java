...
public class A_TryCatch {
	 ...
	 * 
	 * 예외는 발생하더라도 수습 될 수있는 비교적 덜 심가한 것
	 * 
	 * Object -> Throwable -> Exception / Error
	 * 
	 * Exception -->
	 * 					IOException - FileNotFoundException, SocaketException
	 ...
	 * try{
	 * 
	 * 		// 예외가 발생 할 가능성이 있는 코드들
	 * 
	 * } catch(예외클래스 예외변수명) {
	 * 
	 * 		// try에서 예외가 발생하면 실행을 멈추고 catch로 들어와서 예외처리 코드 실행
	 * 
	 * } finally {
	 * 
	 * 
...
//			e.printStackTrace();
			// getMesage : 발생한 예외클래스의 객체에 저장된 메시지를 얻을 수 있음
