...
//		variable.variableTest();
	...
	public void printValue() {
		...
		System.out.println(r * r * pi);	 // syso ctrl + spacebar -> enter
	...
	public void variableTest() {
		 ...
		 *   - 변수명 : 변수의 이름으로 값을 읽고, 쓰고, 지우는 작없을 할 때 사용
		 *   
		 * * 변수의 초기화
		 * 
		 *   변수명 = 값;
		...
		// 2. 문자형 2byte(=16bit)
		char ch = 'a';
//		ch = 'b'; 에러 발생 --> 주석단축키 : ctrl + /
		
		// 3. 정수형
		byte bNum = 1; // 1byte(=8bit)(-128 ~ 127) 256 =2^8
//		bNum = 128; 에러 발생 --> 오버플로우(Overflow)
		short sNum = 123; // 2Byte(=12bit)
		int iNum = 922337283; // 4bye(=32bit) (기본)
		long lNum = 922337293458L; // 8byte(=64bit) 숫자 뒤에  L(l)을 입력
...
//		int int;
		...
		int maxnumber;
		int max_number; // 자바에서 X, 파이썬에서 O (스네이크 표기법)
		int maxNumber; // 자바에서 사용하는 형태(카멜케이스) 
