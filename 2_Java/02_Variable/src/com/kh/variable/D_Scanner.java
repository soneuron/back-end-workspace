...
public class D_Scanner {
	 ...
	 *    
	 *    => 권장하기는 sc.nextLine()만 사용하는 것을 권장 -> "sc.nextLine()만 enter 처리를 함"
	 * */
	...
	public static void main(String[] args) {
		...
		System.out.print("당신의 키는 몇입니까? (소수점 첫째 자리 까지 입력하세요.) >");
		...
		System.out.println("당신의 이름은 " + name + "이고, 사는곳은 " + addr + ", 나이는 " + age + "살, 키는" + height + "cm, 성별은 " + gender + "자 입니다.");
		// printf 로 변경

		System.out.printf("당신의 이름은 %s이고, 사는곳은 %s, 나이는%d살, 키는 %.1fcm, 성별은%c 입니다.", name, addr, age, height, gender);
	}
