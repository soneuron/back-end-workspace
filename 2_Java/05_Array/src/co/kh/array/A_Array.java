...
public class A_Array {
	 ...
	 * 자료형[] 배열명;
	 * 자료형 배열명[]
	 * - 배열을 선언한다고 해서 값을 저장 할 공간이 생성되는 것이 아니라
	 * 	 배열을 다루는 데 필요한 변수가 생성
	 * 
	 * 배열의 초기화
	 * 배열명 = new 자료형[배열크기];
	 * - 생성된 배열에 처음으로 값을 저장
	...
	/*
	 * 3명의 키를 입력받아 배열에 저장하고 3명 키의 평균값을 구하시오
	 * 키 입력 > 180
	 * 키 입력 > 177.3
	 * 키 입력 > 168.2
	 * 175.2
	...
	public void method3() {
		...
		double[] tall = {cm1, cm2, cm3};
		
		double avg = (cm1+cm2+cm3)/3;
	...
	public void method6() {
		...
		System.arraycopy(number, 0, number, 0, number.length);
	...
	// 3) Arrays 클래스에서 제공하는 copyOf()메서드를 이요한 깊은 복사
	...
	// 4) 배열의 clone() 메서드를 이용한 깊은 복사 (이것만 알아도됨)
	public void method8() {
		int[] number = {1, 2, 3, 4, 5};
