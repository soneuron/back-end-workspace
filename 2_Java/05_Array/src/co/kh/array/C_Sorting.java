...
public class C_Sorting {
	...
	// 최대값과 최소값구 하기
	public void method3() {
		int[] score = {79, 88, 97, 44, 100, 55, 95};
		
		Arrays.sort(score);
		System.out.println("최대값 : " + score[score.length -1]);
		System.out.print("최소값 : " + score[0]);
	}
	 ...
	 * - 에이터 양이 적을 때 좋음, 하지만 100개 이상인 경우 급격한 속도 저하
	 * */
	public void method4() {
		int[] arr = {7, 5, 9, 0, 3, 1, 6, 2, 4, 8};
	 ...
	 * - 필요할 때만 위치를 바꿈으로 '데이터가 거의 정렬되어있을 때' 효율적
	 * */
	public void method5() {
		int[] arr = {7, 5, 9, 0, 3, 1, 6, 2, 4, 8};
