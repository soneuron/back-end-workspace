...
public class B_Time {
	...
	public void method1() {
		 ...
		 * */
		 ...
		 System.out.println(now.getDayOfWeek()); // THORSDAY
	...
	public void method3() {
		...
		LocalDate dDay = LocalDate.parse(date);
//		System.out.println(dDay);
		
//		Period pe = Period.between(localDate, dDay);
		System.out.println("D-DAY " + ChronoUnit.DAYS.between(localDate, dDay));
	}
