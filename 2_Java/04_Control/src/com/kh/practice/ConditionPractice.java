...
//		c.method11();
    ...
    public void method3() {
        ...
        int pizza = people/piece;
        if(piece>1 && piece<=10) {
        	if (people%piece == 0) {
        		System.out.println(pizza);
        	} else if (people%piece != 0){
...
//    		System.out.println("평균 : " + String.format("%.1f", avg));
    ...
    public void method5() {
    	...
    	if(price>=500000) {
    		System.out.print((int)(price-(price*0.2)));
    	} else if (price>=300000) {
    		System.out.print((int)(price-(price*0.1)));
    	} else if (price>=100000) {
    		System.out.print((int)(price-(price*0.05)));
    	} else {
    ...
    */
    ...
    public void method9() {
    	...
    	if (num1 >0 && num2 >0 && ch.equals("+")) {
    		System.out.println(num1+" + "+num2 + " = " + (num1+num2));
    	} else if (num1 >0 && num2 >0 && ch.equals("-")) {
    		System.out.println(num1+" - "+num2 + " = " + (num1-num2));
    	} else if (num1 >0 && num2 >0 && ch.equals("*")) {
    		System.out.println(num1+" * "+num2 + " = " + (num1*num2));
    	} else if (num1 >0 && num2 >0 && ch.equals("/")) {
    ...
    public void method11() {
    	...
    	double score = (score1*0.2)+(score2*0.3)+(score3*0.3)+score4;
    	if (score>=70 && score4>=14) {
