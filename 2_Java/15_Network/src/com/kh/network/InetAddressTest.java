 ...
 * - xxx.xxx.xxx.xxx:3000와 같은 형식으로 표현(xxx는 부호 없는 0 ~ 255사이의 정수)
 * - DNS(Domain Name System)를 통해 해당 도메인의 IP주소를 알아낼 수 있다
 * 
 * 포트(prot)
 * - IP 주소는 네트워크 상에서 컴퓨터를 찾을 때만 사용하고
 *   컴푸터 내에서 실행하는 프로그램을 선택하기 위해 포트(Port)사용
 * - 클라이언트는 서버 연결 요청 시 IP주소와 포트 번호를 알고 있어야 한다
...
public class InetAddressTest {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("호스트 IP주소 : " + ip.getHostAddress());
