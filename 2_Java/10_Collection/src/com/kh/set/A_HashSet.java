...
// HachSet : Set 인터페이스를 구현한 대표적인 컬렉션 클래스
public class A_HashSet {
	...
	public void method1() {
		...
		System.out.println("구교환이 포함되어 있는가? " + set.contains("구교환")); // 포함되어있으면 true, 포함되어있지 않으면 false
		...
		set.clear();
		System.out.println(set);
		System.out.println("비어있는지? " + set.isEmpty()); // 비어있으면 true, 비어있지 않으면 false
	}
