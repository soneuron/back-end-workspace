 ...
 * - 미완성 클래스이기 때문에 new 연산자를 통해서 객체 생성이 안된다.
 * - 일반적인 멤버(변수, 메서드) 포함 가능 (변수 + 메서드 + 추상메서드)
 * - 객체 생성 할 수 없지만 참조형 변수 타입으로는 사용 가능
...
public class Application {
	...
	public static void main(String[] args) {
		...
		// Sports s = new Sports(5); -> 추상클래스 객체 생성 x
		...
		// 피자 관련된 출력 과정
		Pizza[] pizza = {
				new BulgogiPizza(30000, "피자헛", "불고기"),
				new PotatoPizza(20000, "도미노피자", "감자"),
				new PineApplePizza(10000, "잭슨피자",  "파인애플")
		};
