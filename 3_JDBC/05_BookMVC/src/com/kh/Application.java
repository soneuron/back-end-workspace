...
public class Application {
	...
	public void sellBook() {
		...
		if(bc.sellBook(no)) {
			System.out.println("성곡적으로 책을 삭제했습니다.");
		} else {
	...
	public void printRentBook() {
		...
		for(Rent rent : rc.printRentBook(member.getMemberNo())) {
			...
			System.out.println(rent.getRentNo()+
								". 책 제목 : "+rent.getBook().getBkTitle()+
								" / 글쓴이 : "+rent.getBook().getBkAuthor()+
								" / 대여날짜 : "+rent.getRentDate()+
	...
	public void deleteMember() {
		if(mc.deleteMember(member.getMemberNo())) {
			...
			System.out.println("회원 탈퇴하는데 실패하였습니다.");
		}
	}
